...
import org.kgcc.fantalmod.effect.LightingStatusEffect;
...
public class FantalModStatusEffects {
    ...
    public static final StatusEffect LIGHTING = new LightingStatusEffect();
    ...
    public static void registerEffects() {
        ...
        FantalModStatusEffects.register(LIGHTING, "lighting");
    }
}
